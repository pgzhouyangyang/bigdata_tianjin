  ...
  <div class="home">
    ...
    <div class="homeLeft fl">
      <div class="LeftBox">
        ...
        <echarts1 :echarObj="echarObj" :xzqhCode="orgcode"></echarts1>
         </div>
      </div>
      <div class="LeftBox">
        <h3>股东类型</h3>
...
<script>
import Echarts1 from "./hasTableECharts";
import Echarts2 from "./gbTypeECharts";

import Echarts3 from "./gbCountEcharts";
import Echarts4 from "./ljfhEcharts";
import Echarts5 from "./lhzcEcharts";
